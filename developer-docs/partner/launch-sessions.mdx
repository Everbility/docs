...
A **launch session** is one report hand-off: your platform creates it, the assigned clinician completes the report in Everbility, and your platform pulls the finished document back. Sessions expire after **48 hours** if not completed.
